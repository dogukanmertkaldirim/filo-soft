    ...
    <div className="pb-20 sm:pb-6">
      {activeTab === 'home' && (
        <div className="space-y-4">
          ...
          <button
            onClick={() => setActiveTab('traffic_fines')}
            className="w-full p-4 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-sm text-left text-white"
          >
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-white/20 rounded-lg backdrop-blur-sm">
              ...
              <div>
                <p className="text-sm font-semibold">Trafik Cezalari</p>
                <p className="text-xs text-orange-100 mt-0.5">Ceza kaydi girin, sofor atama yapin</p>
              </div>
            </div>
          </button>
      ...
      {activeTab === 'traffic_fines' && user && companyId && (
        <div className="space-y-4">
          <button
            onClick={() => setActiveTab('home')}
            className="text-sm text-teal-600 font-medium flex items-center gap-1 mb-2"
